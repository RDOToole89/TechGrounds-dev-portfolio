...
// useRef when you need information that is available regardless of component lifecycle and whose changes should NOT trigger rerenders. Use useState for information whose changes should trigger rerenders.
  ...
  return (
    <Wrapper>
      ...
      <input
        ...
        ref={inputRef}
      />
      <div style={{ color: 'blue', height: '20px', margin: '20px 0' }}> divider</div>
      <Button
        style={{ color: 'grey' }}
